...
// ✅ Fix class → className
const Logo = () => (
  <img src={logoImg} className="h-20" alt="Shree Ganesh Traders" />
);
...
const ModernLoginPage = () => {
  ...
  const API_LOGIN_URL = `${API_BASE}/api/`;
    ...
    async (prevState, loginData) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          console.log(
            "✅ Encrypted user_id stored in both localStorage and Redux",
          );
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center font-sans overflow-hidden bg-gray-100">
      {/* ...existing code... */}
      <Link
        to="/"
      ...
      {/* left-top trapezium */}
      <div
        className="absolute w-22 h-25 bg-[#f9ac19] [clip-path:polygon(0%_20%,_0%_80%,_80%_100%,_80%_0%)] top-[18%] xl:top-[20%] 2xl:top-[22%] left-[25%] xl:left-[27%] 2xl:left-[30%]"
        style={{ zIndex: 1 }}
      ></div>
      {/* left-bottom triangle */}
      <div
        className="absolute w-22 h-25 bg-[#f15a24] [clip-path:polygon(50%_0%,_0%_100%,_100%_100%)] rotate-[270deg] opacity-70 top-[41%] xl:top-[44%] 2xl:top-[47%] left-[27%] xl:left-[29%] 2xl:left-[31%]"
        style={{ zIndex: 1 }}
      ></div>
      {/* right-bottom trapezium */}
      <div
        className="absolute w-22 h-25 bg-[#f9ac19] [clip-path:polygon(0%_20%,_0%_80%,_80%_100%,_80%_0%)] rotate-[180deg] top-[58%] xl:top-[61%] 2xl:top-[64%] left-[68%] xl:left-[66%] 2xl:left-[64%]"
        style={{ zIndex: 1 }}
      ></div>
      {/* right-top triangle */}
      <div
        className="absolute w-22 h-25 bg-[#048bb4] [clip-path:polygon(50%_0%,_0%_100%,_100%_100%)] rotate-[90deg] top-[28%] xl:top-[30%] 2xl:top-[32%] left-[66%] xl:left-[64%] 2xl:left-[62%]"
        style={{ zIndex: 1 }}
      ></div>
