  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      ...
      >
        ...
        <div
          className="w-64 flex-shrink-0 flex flex-col p-8 relative overflow-hidden"
          style={{
            background:
              "linear-gradient(180deg, rgba(231, 242, 245, 0.9) 0%, rgba(255, 255, 255, 1) 100%)",
              ...
              return (
                <div key={s.id} className="relative flex items-center gap-4">
                  ...
                  <div className="flex flex-col">
                    <p
                      className={`text-sm font-semibold transition-all ${isActive ? "text-slate-900" : "text-slate-400"}`}
                    >
                      {s.label}
                    </p>
                    {isActive && (
                      <p className="text-[10px] text-[#0c7c9d] font-medium mt-0.5">
                        Current Step
                      </p>
                    )}
                  </div>
          ...
          <div className="flex items-center justify-between px-7 py-4 border-t border-gray-100 bg-gray-50">
            ...
            {step < STEPS.length - 1 ? (
              <button
                ...
                onMouseEnter={(e) =>
                  (e.currentTarget.style.backgroundColor = "#e0841a")
                }
                onMouseLeave={(e) =>
