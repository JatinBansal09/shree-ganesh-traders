...
const LogoMark = ({ size = 40 }) => (
  ...
  >
    <span style={{ color: "#fff", fontWeight: "bold", fontSize: size / 2 }}>
      🔧
    </span>
  </div>
);
...
const Hero = () => (
  ...
  >
    ...
    >
      <div>
        ...
        >
          Supplying premium plumbing materials to retailers, builders,
          contractors, and dealers across Punjab. Competitive pricing and
  ...
  * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
  ...
  @media (max-width: 768px) {
    ...
    .hero-stats { flex-direction: row !important; flex-wrap: wrap !important; }
    .hero-stat-card { flex: 1 !important; min-width: 100px !important; padding: 16px !important; }
    ...
    .nav-logo-img { width: 55px !important; height: 55px !important; }
  ...
  <div style={{ textAlign: "center", marginBottom: 56 }}>
    <div
      style={{
        ...
        border: "1px solid rgba(232,121,10,0.22)",
        borderRadius: 100,
        padding: "4px 16px",
      }}
    >
...
const Categories = ({ categories }) => (
  <section
    id="categories"
    style={{ padding: "100px 5vw", background: "#f9f9fb" }}
  >
      ...
      >
        {categories.map((cat, i) => (
          ...
          >
            ...
            <div style={{ color: "#E8790A", fontSize: 12, fontWeight: 600 }}>
              {cat.count}
            </div>
          </div>
        ))}
  ...
  const points = [
    {
      ...
      body: "Every item is sourced directly from manufacturers or authorised distributors. Zero counterfeits, guaranteed.",
    },
    {
      icon: "💸",
      title: "Wholesale Pricing",
      body: "Volume-linked pricing tiers for retailers, builders, and contractors. The more you buy, the better your margin.",
    },
    {
      icon: "🚚",
      title: "Pan-Punjab Delivery",
      body: "Our own logistics network covers Ludhiana, Jalandhar, Amritsar, Patiala, and 8 more cities with next-day dispatch.",
    },
    {
      icon: "📱",
      title: "Digital Order Management",
      body: "Place orders, track deliveries, and manage payments through our dedicated dealer portal — available 24×7.",
    },
    {
      icon: "🤝",
      title: "Dedicated Account Manager",
      body: "Every registered dealer gets a single point of contact for pricing, availability, and escalation support.",
    },
    {
      icon: "📦",
      title: "Deep Stock Availability",
      body: "1,400+ SKUs in warehouse with real-time stock visibility. No surprises on delivery day.",
    },
  ];
            ...
            >
              <div
                style={{
                  ...
                  borderRadius: 12,
                  background: "rgba(232,121,10,0.08)",
                  border: "1px solid rgba(232,121,10,0.18)",
                  display: "flex",
                  alignItems: "center",
                  justifyContent: "center",
                  fontSize: 22,
              ...
              <div style={{ color: "#666", fontSize: 14, lineHeight: 1.75 }}>
                {p.body}
              </div>
            </div>
          ))}
...
const ContactForm = () => {
  ...
  return (
    <section
      id="contact"
      style={{ padding: "100px 5vw", background: "#ffffff" }}
    >
      <div
      ...
      >
        ...
        <div>
          ...
          >
            Whether you're looking for bulk supply, a dealership, or a project
            quote — fill in your details and our team will reach out within one
            business day.
          </p>
          ...
          {[
            ...
            >
              ...
              <div>
                ...
                <div
                  style={{ color: "#1a1a2e", fontSize: 14, fontWeight: 500 }}
                >
                  {item.value}
                </div>
              </div>
          ...
          {done ? (
            <div style={{ textAlign: "center", padding: "40px 0" }}>
              ...
              <p style={{ color: "#777", fontSize: 14, lineHeight: 1.7 }}>
                Our team will get back to you within one business day. Thank you
                for your interest in partnering with {SHOP.name}.
              </p>
            </div>
          ) : (
            <form
            ...
            >
              ...
              <button
                ...
                style={{
                  padding: "13px",
                  background: submitting ? "#aaa" : "#1a1a2e",
                  color: "#fff",
                  border: "none",
                  borderRadius: 9,
                  fontSize: 15,
                ...
                onMouseEnter={(e) => {
                  if (!submitting) e.target.style.background = "#E8790A";
                }}
                onMouseLeave={(e) => {
                  if (!submitting) e.target.style.background = "#1a1a2e";
                }}
              >
    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <div>
          ...
          >
            © {new Date().getFullYear()} All rights reserved · GST: {SHOP.gst}
          </div>
        </div>
      </div>
